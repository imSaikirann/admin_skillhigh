...
export default function Departments() {
  ...
  return (
    <div className="container bg-white dark:bg-darkBg  mx-auto p-8 pl-0 sm:pl-72 font-poppins  h-screen">
        <Alert 
      ...
      {loading ? (
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 mt-24 sm:mt-0">
          {departments.map((department) => (
            <div
              key={department.id}
              className="bg-white dark:bg-darkColor text-white  rounded-lg p-6 border dark:border-darkColor shadow-md relative"
            >
